...
\subsection{3.2 A Graph Model for False Negative Handling in Indoor RFID Tracking Data} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
